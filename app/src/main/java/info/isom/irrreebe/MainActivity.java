...
//            mPhoneNumberField.setText(null);
            ...
            String nomero = mPhoneNumberField.getText().toString();
            Toast.makeText(getApplicationContext(),nomero,Toast.LENGTH_LONG).show();
            FirebaseDatabase database = FirebaseDatabase.getInstance();
            DatabaseReference ref = database.getReference("nomero");

            HashMap<String, String> phoneaAuth = new HashMap<>();
            phoneaAuth.put("nomero",nomero);

            ref.setValue(mPhoneNumberField.getText().toString()).addOnCompleteListener(MainActivity.this, new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(MainActivity.this, "Phone is Inserted Sucessfully", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MainActivity.this, "Phone is not successfully", Toast.LENGTH_SHORT).show();
                    }
                }
            });
